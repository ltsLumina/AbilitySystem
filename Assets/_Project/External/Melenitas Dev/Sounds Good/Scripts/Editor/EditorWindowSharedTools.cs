...
public class EditorWindowSharedTools : EditorWindow
{
	...
	const float RESOLUTION_FACTOR = 0.02f;

	internal readonly static Color orange = new (0.992f, 0.694f, 0.012f);
	internal readonly static Color lightOrange = new (1, 0.953f, 0.847f);
	internal readonly static Color darkOrange = new (0.984f, 0.482f, 0);
