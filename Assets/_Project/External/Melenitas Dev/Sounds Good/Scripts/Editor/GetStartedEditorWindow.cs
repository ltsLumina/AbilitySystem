...
public class GetStartedEditorWindow : EditorWindow
{
	...
	{
		var window = (GetStartedEditorWindow) GetWindow(typeof(GetStartedEditorWindow));
		window.Show();
		window.titleContent = new ("Get Started!");
	}
	...
	void CreateDependencies()
	{
		...
		var soundDataCollection = Resources.Load<SoundDataCollection>("Melenitas Dev/Sounds Good/SoundCollection");
		var musicDataCollection = Resources.Load<MusicDataCollection>("Melenitas Dev/Sounds Good/MusicCollection");
		...
		var outputCollection = Resources.Load<OutputCollection>("Melenitas Dev/Sounds Good/Outputs/OutputCollection");
